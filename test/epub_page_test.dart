...
''';
        ...
        expect(renderedLines.join(' '), contains('Mozzarella'));
        expect(renderedLines.join(' '), contains('strips'));
        ...
        expect(renderedLines.join(' '), contains('cloves'));
        expect(renderedLines.join(' '), contains('Breadcrumbs'));
        expect(renderedLines.join(' '), contains('25g'));
        expect(renderedLines.join(' '), contains('Walnuts,'));
        expect(renderedLines.join(' '), contains('chopped finely'));
