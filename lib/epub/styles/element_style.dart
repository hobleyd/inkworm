...
class ElementStyle extends Style {
  ...
  void setTextStyle({FontWeight weight = FontWeight.w700, TextDecoration decoration = TextDecoration.none}) {
    textStyle = textStyle.copyWith(fontWeight: weight, decoration: decoration);
  }
